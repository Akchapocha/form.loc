...
<main class="main">
	<div class="container">
		...
		<section class="comments-bottom">
			...
			<form action="" class="comment-form clearfix" action="" method="post">
				<label for="name" class="comment-form__label">Ваше имя</label>
				<input type="text" class="comment-form__input" name="name" id="name" placeholder="Введите Ваше имя" value="<?php echo @$_POST['name']?>">
				<label for="message" class="comment-form__label">Ваш комментарий</label>
				<textarea class="comment-form__input comment-form__input--textarea" name="message" id="message" placeholder="Введите Ваш комментарий"><?php echo @$_POST['message']?></textarea>
				<?val();?>
